...
#' @param corine_code A character vector. Vector of the Corine classes (level 3) for which the average
...
#'
compute_area <- function(nuts = "Italia", h = 3, last_yr, corine_code) {
